      ...
      <div className={`${styles['about-homepage-aligner']}`}>
        ...
        <div className={`${styles['about-info-container']}`}>
          ...
          <p>
            ...
            sodales, felis a ornare tempor, quam nulla ullamcorper ligula, vitae
            feugiat sapien nibh vitae enim. In hac habitasse platea dictumst.
            Curabitur sit amet lorem ipsum. Quisque fringilla nibh ante, vitae
            semper nulla dictum ac. Morbi varius consequat nisi, quis molestie
            mauris scelerisque eu. Vestibulum ante ipsum primis in faucibus orci
            luctus et ultrices posuere cubilia curae; Ut accumsan nisi ac mi
            tempus suscipit.
          </p>
        </div>
